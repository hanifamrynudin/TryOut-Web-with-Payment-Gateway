...
<a href="<?php echo site_url('user/switch_group');?>" class="btn btn-danger"><?php echo $this->lang->line('change_group');?></a>
			...
			<div class="form-group">	 
				<label for="inputEmail" class="sr-only"><?php echo $this->lang->line('email_address');?></label> 
				<input type="text" id="inputEmail" name="uid" value="<?php echo $result['uid'];?>" readonly=readonly class="form-control" placeholder="<?php echo $this->lang->line('uid');?>" required autofocus>
			</div>
			<div class="form-group">	  
