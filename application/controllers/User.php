...
class User extends CI_Controller {
	...
	public function change_group_detail($gid){
			...
			$this->load->view('header',$data);
			$this->load->view('change_group_detail',$data);
			$this->load->view('footer',$data);
	...
	public function change_group_history()
	{
		
		// fetching group list
		$data['midtrans'] = $this->db->get('trans_midtrans')->result();
		$this->load->view('header',$data);
		$this->load->view('change_group_history',$data);
		$this->load->view('footer',$data);
	}
