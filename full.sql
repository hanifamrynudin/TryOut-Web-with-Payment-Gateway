...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Feb 2021 pada 23.49
...
--
-- Struktur dari tabel `savsoftquiz_custom_form`
--
...
--
-- Struktur dari tabel `savsoftquiz_setting`
--
...
--
-- Dumping data untuk tabel `savsoftquiz_setting`
--
...
--
-- Struktur dari tabel `savsoft_add`
--
...
--
-- Dumping data untuk tabel `savsoft_add`
--
...
--
-- Struktur dari tabel `savsoft_answers`
--
...
--
-- Dumping data untuk tabel `savsoft_answers`
--
...
(148, 79, '301', 1, 0, 18, 0),
(150, 80, '306', 1, 0, 18, 1),
(152, 118, '481', 5, 1, 19, 0),
(154, 118, '480', 14, 0, 20, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `savsoft_category`
--
...
--
-- Dumping data untuk tabel `savsoft_category`
--
...
--
-- Struktur dari tabel `savsoft_group`
--
...
--
-- Dumping data untuk tabel `savsoft_group`
--
...
--
-- Struktur dari tabel `savsoft_level`
--
...
--
-- Dumping data untuk tabel `savsoft_level`
--
...
--
-- Struktur dari tabel `savsoft_notification`
--
...
--
-- Dumping data untuk tabel `savsoft_notification`
--
...
--
-- Dumping data untuk tabel `savsoft_options`
--
...
--
-- Struktur dari tabel `savsoft_payment`
--
...
--
-- Dumping data untuk tabel `savsoft_payment`
--
...
--
-- Dumping data untuk tabel `savsoft_qbank`
--
...
(118, 'Multiple Choice Single Answer', '<p>Who is in the picture?<img src=\"../../../../savsoftquiz_v4.0_enterprise/upload/word_images/15091002001.jpeg\" /></p>', '', NULL, NULL, 2, 1, 4, 1, 1, 2, 0, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `savsoft_qcl`
--
...
--
-- Dumping data untuk tabel `savsoft_qcl`
--
...
--
-- Struktur dari tabel `savsoft_quiz`
--
...
--
-- Dumping data untuk tabel `savsoft_quiz`
--
...
(10, 'coba', '', 1612998488, 1644534488, '1', '118', 1, '1', '0', '', 10, 10, 50, 1, 0, 0, 0, NULL, 1, 'Default', NULL, 1, 'Admin Admin', 1, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `savsoft_result`
--
...
--
-- Dumping data untuk tabel `savsoft_result`
--
...
(19, 10, 5, 'Pass', 1613045498, 1613045507, 'Math', '1', '118', '5', 5, 1, 100, '::1', '1', '', 0),
(20, 10, 14, 'Fail', 1613045518, 1613045527, 'Math', '1', '118', '0', 0, 0, 0, '::1', '2', '', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `savsoft_users`
--
...
--
-- Dumping data untuk tabel `savsoft_users`
--
...
(14, 'e10adc3949ba59abbe56e057f20f883e', 'user123@example.com', 'Hanif', 'Fadillah', '', NULL, '1', 2, 0, 1928341800, 0, NULL, '2021-02-11 12:02:44', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata');

-- --------------------------------------------------------

--
-- Struktur dari tabel `savsoft_users_custom`
--
...
--
-- Dumping data untuk tabel `savsoft_users_custom`
--
...
--
-- Struktur dari tabel `social_group`
--
...
--
-- Dumping data untuk tabel `social_group`
--
...
--
-- Struktur dari tabel `social_group_joined`
--
...
--
-- Dumping data untuk tabel `social_group_joined`
--
...
--
-- Struktur dari tabel `study_material`
--
...
--
-- Dumping data untuk tabel `study_material`
--
...
INSERT INTO `transaksi_midtrans` (`order_id`, `gross_amount`, `payment_type`, `transaction_time`, `bank`, `va_number`, `status_code`) VALUES
('1057526578', 100, 'bank_transfer', '2021-02-11 14:07:27', 'bca', '16017143301', '201'),
('1074757209', 100, 'bank_transfer', '2021-02-11 18:41:04', 'bca', '16017764585', '201'),
('1103469825', 100, 'bank_transfer', '2021-02-11 14:48:48', 'bca', '16017781463', '201'),
('1133077541', 100, 'gopay', '2021-02-11 15:08:44', '-', '-', '201'),
('1238119300', 100, 'bank_transfer', '2021-02-11 16:08:28', 'bca', '16017108881', '201'),
('1251165362', 100, 'bank_transfer', '2021-02-11 16:07:28', '-', '-', '201'),
('1326482634', 10000, 'bank_transfer', '2021-02-11 15:51:50', 'bni', '9881601762407910', '201'),
('1327944401', 100, 'bank_transfer', '2021-02-11 14:19:10', '-', '-', '201'),
('1358172590', 100, 'gopay', '2021-02-11 16:08:49', '-', '-', '201'),
('1365280736', 100, 'bank_transfer', '2021-02-11 14:41:27', '-', '-', '201'),
('1368219703', 100, 'bank_transfer', '2021-02-11 15:23:47', 'bca', '16017562806', '201'),
('1390485222', 100, 'bank_transfer', '2021-02-11 15:06:39', '-', '-', '201'),
('1468617961', 100, 'bank_transfer', '2021-02-11 13:53:09', 'bca', '16017971932', '201'),
('1750472925', 100, 'bank_transfer', '2021-02-11 15:35:13', 'bca', '16017713506', '201'),
('186381014', 100, 'bank_transfer', '2021-02-11 14:11:14', 'bca', '16017239489', '201'),
('2109181512', 100, 'bank_transfer', '2021-02-11 14:43:19', '-', '-', '201'),
('2118444227', 15000, 'bank_transfer', '2021-02-11 15:08:05', 'bca', '16017265531', '201'),
('23556879', 100, 'bank_transfer', '2021-02-11 15:54:20', '-', '-', '201'),
('287148798', 100, 'bank_transfer', '2021-02-11 15:21:04', '-', '-', '201'),
('439237546', 2500, 'bank_transfer', '2021-02-11 14:15:40', 'bca', '16017928520', '201'),
('485654088', 10000, 'bank_transfer', '2021-02-11 17:45:52', 'bca', '16017123530', '201'),
('55931303', 100, 'gopay', '2021-02-11 14:41:01', '-', '-', '201'),
('604849531', 15000, 'gopay', '2021-02-11 17:25:52', '-', '-', '201'),
('816548942', 100, 'bank_transfer', '2021-02-11 16:06:44', '-', '-', '201'),
('985622051', 100, 'bank_transfer', '2021-02-11 14:59:18', '-', '-', '201'),
('987367045', 100, 'gopay', '2021-02-11 14:49:41', '-', '-', '201');

-- --------------------------------------------------------

--
-- Struktur dari tabel `trans_midtrans`
--

CREATE TABLE `trans_midtrans` (
  `order_id` char(20) NOT NULL,
...
--
-- Dumping data untuk tabel `trans_midtrans`
--

INSERT INTO `trans_midtrans` (`order_id`, `email`, `kelas`, `gross_amount`, `payment_type`, `transaction_time`, `bank`, `va_number`, `status_code`) VALUES
('112697586', 'user123@example.com', '3 diamond', 15000, 'bank_transfer', '2021-02-12 05:45:42', 'bni', '9881601780550058', '201'),
('1544744581', 'user@example.com', 'Premium-1', 100, 'bank_transfer', '2021-02-12 05:22:12', 'bca', '16017184038', '201');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_midtrans`
--

CREATE TABLE `t_midtrans` (
  `order_id` char(20) NOT NULL,
  `uid` int(11) NOT NULL,
  `gross_amount` int(11) NOT NULL,
  `payment_type` varchar(13) NOT NULL,
...
--
-- Dumping data untuk tabel `t_midtrans`
--

INSERT INTO `t_midtrans` (`order_id`, `uid`, `gross_amount`, `payment_type`, `transaction_time`, `bank`, `va_number`, `status_code`) VALUES
('1680528768', 14, 100, 'bank_transfer', '2021-02-11 19:48:51', 'bca', '16017878430', '201'),
('347994783', 0, 100, 'bank_transfer', '2021-02-11 20:25:46', 'bca', '16017716920', '201'),
('473127435', 0, 100, 'gopay', '2021-02-11 20:22:58', '-', '-', '201'),
('789076877', 0, 100, 'bank_transfer', '2021-02-11 20:23:37', 'bni', '9881601741297991', '201');

-- --------------------------------------------------------

--
-- Struktur dari tabel `warning_message`
--
...
--
-- Dumping data untuk tabel `warning_message`
--
...
--
-- Indeks untuk tabel `savsoftquiz_custom_form`
--
ALTER TABLE `savsoftquiz_custom_form`
  ADD PRIMARY KEY (`field_id`);

--
-- Indeks untuk tabel `savsoftquiz_setting`
--
ALTER TABLE `savsoftquiz_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indeks untuk tabel `savsoft_add`
--
ALTER TABLE `savsoft_add`
  ADD PRIMARY KEY (`add_id`);

--
-- Indeks untuk tabel `savsoft_answers`
--
ALTER TABLE `savsoft_answers`
  ADD PRIMARY KEY (`aid`);

--
-- Indeks untuk tabel `savsoft_category`
--
ALTER TABLE `savsoft_category`
  ADD PRIMARY KEY (`cid`);

--
-- Indeks untuk tabel `savsoft_group`
--
ALTER TABLE `savsoft_group`
  ADD PRIMARY KEY (`gid`);

--
-- Indeks untuk tabel `savsoft_level`
--
ALTER TABLE `savsoft_level`
  ADD PRIMARY KEY (`lid`);

--
-- Indeks untuk tabel `savsoft_notification`
--
...
--
-- Indeks untuk tabel `savsoft_payment`
--
...
--
-- Indeks untuk tabel `savsoft_qcl`
--
ALTER TABLE `savsoft_qcl`
  ADD PRIMARY KEY (`qcl_id`);

--
-- Indeks untuk tabel `savsoft_quiz`
--
ALTER TABLE `savsoft_quiz`
  ADD PRIMARY KEY (`quid`);

--
-- Indeks untuk tabel `savsoft_result`
--
ALTER TABLE `savsoft_result`
  ADD PRIMARY KEY (`rid`);

--
-- Indeks untuk tabel `savsoft_users`
--
ALTER TABLE `savsoft_users`
  ADD PRIMARY KEY (`uid`);

--
-- Indeks untuk tabel `savsoft_users_custom`
--
ALTER TABLE `savsoft_users_custom`
  ADD PRIMARY KEY (`c_id`);

--
-- Indeks untuk tabel `social_group`
--
ALTER TABLE `social_group`
  ADD PRIMARY KEY (`sg_id`);

--
-- Indeks untuk tabel `social_group_joined`
--
ALTER TABLE `social_group_joined`
  ADD PRIMARY KEY (`join_id`);

--
-- Indeks untuk tabel `study_material`
--
...
--
-- Indeks untuk tabel `trans_midtrans`
--
ALTER TABLE `trans_midtrans`
  ADD PRIMARY KEY (`order_id`);

--
-- Indeks untuk tabel `t_midtrans`
--
ALTER TABLE `t_midtrans`
  ADD PRIMARY KEY (`order_id`);

--
-- Indeks untuk tabel `warning_message`
--
...
--
-- AUTO_INCREMENT untuk tabel `savsoftquiz_custom_form`
--
ALTER TABLE `savsoftquiz_custom_form`
  MODIFY `field_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `savsoftquiz_setting`
--
ALTER TABLE `savsoftquiz_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT untuk tabel `savsoft_add`
--
ALTER TABLE `savsoft_add`
  MODIFY `add_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `savsoft_answers`
--
ALTER TABLE `savsoft_answers`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT untuk tabel `savsoft_category`
--
ALTER TABLE `savsoft_category`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `savsoft_group`
--
ALTER TABLE `savsoft_group`
  MODIFY `gid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `savsoft_level`
--
ALTER TABLE `savsoft_level`
  MODIFY `lid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `savsoft_notification`
--
ALTER TABLE `savsoft_notification`
...
--
-- AUTO_INCREMENT untuk tabel `savsoft_payment`
--
ALTER TABLE `savsoft_payment`
